...
{
    Graph g1(5);
    g1.addUndirectEdge(1, 0);
    g1.addUndirectEdge(0, 2);
    g1.addUndirectEdge(1, 2);
    g1.addUndirectEdge(0, 3);
    g1.addUndirectEdge(3, 4);
    g1.isCycleUndirect()? cout << "Graph contains cycle\n":
                   cout << "Graph doesn't contain cycle\n";
 
    Graph g2(3);
    g2.addUndirectEdge(0, 1);
    g2.addUndirectEdge(1, 2);
    g2.isCycleUndirect()? cout << "Graph contains cycle\n":
                   cout << "Graph doesn't contain cycle\n";
